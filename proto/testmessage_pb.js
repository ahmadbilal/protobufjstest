 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.TestMessage.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getSometext();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!proto.TestMessage} The clone.
 */
proto.TestMessage.prototype.cloneMessage = function() {
  return /** @type {!proto.TestMessage} */ (jspb.Message.cloneMessage(this));
};
